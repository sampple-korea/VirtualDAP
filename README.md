...
[VirtualDAP 0.1.0-alpha.3 APK 다운로드](https://github.com/sampple-korea/VirtualDAP/releases/download/v0.1.0-alpha.3/VirtualDAP-0.1.0-alpha.3.apk)
· [설치 안내와 제한 사항](https://github.com/sampple-korea/VirtualDAP/releases/tag/v0.1.0-alpha.3)
...
alpha.3는 UAC2 제어 인터페이스 점유 누락과 단일 APK의 설치 묶음 오인을 수정했습니다.
공개 alpha.1/alpha.2와 같은 서명이며, alpha.2 위에 업데이트 설치하는 것을 확인했습니다.
