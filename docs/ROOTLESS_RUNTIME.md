...
Output follows [the official bit-perfect contract](OFFICIAL_OUTPUT.md).
An Android version alone does not prove that a device/DAC/format exposes that capability. Unsupported
combinations are reported without opening another output transport.
